...
import { importSourcesFromLoc } from "@/lib/loc/sourceImport"
...
export async function POST(req: Request) {
  ...
  let works: Awaited<ReturnType<typeof importSourcesFromLoc>>
  try {
    works = await importSourcesFromLoc({
      query,
      title,
      authorName,
      isbn,
    ...
    const message = error instanceof Error ? error.message : "LoC import failed"
